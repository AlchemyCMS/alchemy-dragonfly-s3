...
RSpec.describe Alchemy::PictureVariant do
  ...
  let(:alchemy_picture) { FactoryGirl.build_stubbed(:alchemy_picture, image_file: image_file) }
  ...
  context "when a different format is requested" do
    ...
    context "for an animated gif" do
      ...
      let(:image_file) do
        File.new(File.expand_path("../fixtures/animated.gif", __dir__))
      end
  ...
  context "when jpg format is requested" do
    ...
    context "and image has jpg format" do
      let(:alchemy_picture) do
        FactoryGirl.build_stubbed(:alchemy_picture, image_file: image_file, image_file_format: "jpg")
      end
    ...
    context "and image has jpeg format" do
      let(:alchemy_picture) do
        FactoryGirl.build_stubbed(:alchemy_picture, image_file: image_file, image_file_format: "jpeg")
      end
